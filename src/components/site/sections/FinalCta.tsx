      ...
      <div className="container-page">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p
            ...
            style={{ color: "color-mix(in oklab, white 75%, transparent)" }}
          >
            Sem apresentação comercial, sem material de venda. Apenas uma leitura honesta sobre onde
            a operação está e o que faria diferença no próximo passo.
          </p>
          <div className="mt-10">
            <a
              href="#diagnostico"
